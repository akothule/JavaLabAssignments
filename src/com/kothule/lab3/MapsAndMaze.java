...
public class MapsAndMaze {
    /* A Map is going to be represented by a 2d array of ints where:
     * 0 represents an empty spot
     * 1 represents you
     * 2 represents the finish line or goal
     * 3 represents a wall or obstacle.
     */
    ...
    * _ * _ * * * _ _ *
    ...
    // Returns true if you can move north/south/east/west
    ...
    // Creates a function that returns a minimal path from you to finish.
    ...
    // creates a 3d map with walls and ladders
    ...
    assume the goal is always to get the the very top of the pyramid.
    Level 1:
    Y _ _ _ _
    _ _ _ _ _
    _ _ _ _ _
    ...
    */
    ...
    // Returns true if you can move up/down
